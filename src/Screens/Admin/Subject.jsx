        ...
        <div className="flex flex-col justify-center items-center w-full mt-8">
          <div className="w-[40%] mb-4">
            ...
            <input
              ...
              className="w-full bg-gray-200 rounded border focus:border-green-500 focus:bg-gray-300 focus:ring-2 focus:ring-green-500 text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
          <div className="w-[40%]">
            ...
            {subject &&
              subject.map((item) => {
                return (
                  <li
                    key={item.code}
                    className="bg-gray-100 py-3 px-6 mb-3 flex justify-between items-center w-[70%]"
                  >
                    <div>
                      {item.code} - {item.name}
                    </div>
